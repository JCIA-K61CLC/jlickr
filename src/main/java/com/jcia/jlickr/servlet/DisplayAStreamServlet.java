...
@WebServlet(name = "DisplayAStreamServlet", urlPatterns = "/displayStream")
public class DisplayAStreamServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String sqlCommand = "select photo from images where id = ? and link = ?";
